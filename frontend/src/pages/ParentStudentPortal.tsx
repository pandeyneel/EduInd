  ...
  return (
    <div className="p-8 space-y-8 max-w-[1600px] mx-auto">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
        ...
        {/* Timetable timeline */}
        <div className="xl:col-span-8 bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm flex flex-col h-full">
          <div className="flex justify-between items-center mb-6 pb-4 border-b border-slate-100">
            ...
            <span className="font-label-caps text-[10px] text-slate-400 bg-slate-150 px-2.5 py-1 rounded-full border border-slate-200/50 font-bold select-none">
              Thursday, Oct 26
            </span>
          </div>

          <div className="flex-1 flex flex-col gap-5 relative pl-4">
            {/* Timeline line */}
              ...
              <div className="flex-1 bg-slate-50 border border-slate-200 rounded-xl p-3 flex justify-between items-center">
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 font-medium mt-1 flex items-center gap-1">
                    <MapPin className="w-3 h-3" /> Room 302 • Dr. Aris
                  </p>
                </div>
            ...
            <div className="flex gap-4 items-center relative z-10 group">
              ...
              <div className="flex-1 bg-indigo-50/50 border-l-3 border-l-indigo-600 rounded-r-xl rounded-l-md border-y border-r border-indigo-100 p-3 shadow-sm shadow-indigo-100/5 flex justify-between items-center">
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 font-medium mt-1 flex items-center gap-1">
                    <MapPin className="w-3 h-3" /> Library • Ms. Vance
                  </p>
                </div>
            ...
            <div className="flex gap-4 items-center relative z-10 group">
              ...
              <div className="flex-1 bg-white border border-slate-200 rounded-xl p-3 flex justify-between items-center hover:bg-slate-50 transition-colors cursor-pointer">
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 font-medium mt-1 flex items-center gap-1">
                    <MapPin className="w-3 h-3" /> Room 105 • Mr. Chen
                  </p>
                </div>
        ...
        <div className="xl:col-span-4 bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm flex flex-col h-full">
          <div className="flex justify-between items-center mb-6 pb-4 border-b border-slate-100">
            <h3 className="font-title-sm text-base font-bold text-slate-900 flex items-center gap-2">
          ...
          <button className="mt-6 pt-4 text-indigo-600 font-bold text-xs text-center border-t border-slate-100 w-full hover:text-indigo-700 transition-colors flex items-center justify-center gap-1 group">
            View All Assignments <ArrowRight className="w-3.5 h-3.5 transition-transform group-hover:translate-x-0.5" />
          </button>
        </div>
      </div>

      {/* Recent Grades table */}
      <div className="bg-white border border-slate-200/80 rounded-2xl overflow-hidden shadow-sm flex flex-col mt-4">
        <div className="p-6 border-b border-slate-100 bg-white flex justify-between items-center">
          <h3 className="font-title-sm text-base font-bold text-slate-900 flex items-center gap-2">
            <TrendingUp className="w-[18px] h-[18px] text-emerald-500" /> Recent Assessments
          </h3>
          <button className="p-1.5 rounded-lg border border-slate-250 hover:bg-slate-50 transition-all text-slate-400 hover:text-slate-700">
